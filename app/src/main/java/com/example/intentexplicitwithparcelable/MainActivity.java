    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Rofi'ul Himam");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Rofi'ul Himam");
                mPerson.setAge(17);
                mPerson.setEmail("rofihimam.siswa@smkn4bdg.sch.id");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081903160043";
